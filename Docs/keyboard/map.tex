...
\k 2	Ctrl-B		Toggle speedbrake; \ac{hunter|seahawk} Toggle speedbrake; \ac{p51d} Toggle engine boost
...
\k 11	Ctrl-K		{}
\k 12	Ctrl-L		\ac{hunter|seahawk} Seat default
...
\k 67	C		\ac{bo105} toggle doors
\k 68	D		{}
\k 69	E		{}
\k 70	F		\ac{hunter|seahawk} Wing fold down
\k 71	G		Gear down
\k 72	H		Cycle HUD brightness; \ac{hunter|seahawk} Hook down
\k 73	I		Alternative HUD
...
\k 91	[		Decrease flaps; \ac{737|A320|hunter|seahawk} Decrease flaps; \ac{ComperSwift} Adjust view left; \ac{b52} --
\k 92	\|		{}
\k 93	]		Increase flaps; \ac{737|A320|hunter|seahawk} Increase flaps; \ac{ComperSwift} Adjust view right; \ac{b52} --
\k 94	\^		{}
\k 95	\_~(Underscore)	{}
\k 96	`{}~(Backtick)	{}
...
\k 101	e		{}
\k 102	f		\ac{an225|yf23} Extend slats; \ac{hunter|seahawk} Wing fold up
\k 103	g		Gear Up
\k 104	h		Cycle HUD: green/red/off; \ac{hunter|seahawk} Hook up
\k 105	i		Normal HUD
\k 106	j		Decrease spoilers; \ac{hunter} Jettison inner pylon stores
\k 107	k		Increase spoilers; \ac{hunter|seahawk} Null
\k 108	l		Toggle tail-wheel lock; \ac{hunter|seahawk} Seat up
...
\k 262	F6		Toggles autopilot target location		\shift{Scroll panel up}

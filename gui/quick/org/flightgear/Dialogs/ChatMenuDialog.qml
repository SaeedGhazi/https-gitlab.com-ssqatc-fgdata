...
DialogBase {
    ...
    ColumnLayout {
        ...
        Label {
            text: qsTr("entry-0")
            horizontalAlignment: Text.AlignLeft
            // property*: /sim/multiplay/chat-menu/entry[0]
            // live*: true
            color: "#E63333FF"
        }
        ...
        Label {
            text: qsTr("entry-1")
            horizontalAlignment: Text.AlignLeft
            // property*: /sim/multiplay/chat-menu/entry[1]
            // live*: true
            color: "#E63333FF"
        }
        ...
        Label {
            text: qsTr("entry-2")
            horizontalAlignment: Text.AlignLeft
            // property*: /sim/multiplay/chat-menu/entry[2]
            // live*: true
            color: "#E63333FF"
        }
        ...
        Label {
            text: qsTr("entry-3")
            horizontalAlignment: Text.AlignLeft
            // property*: /sim/multiplay/chat-menu/entry[3]
            // live*: true
            color: "#E63333FF"
        }
        ...
        Label {
            text: qsTr("entry-4")
            horizontalAlignment: Text.AlignLeft
            // property*: /sim/multiplay/chat-menu/entry[4]
            // live*: true
            color: "#E63333FF"
        }
        ...
        Label {
            text: qsTr("entry-5")
            horizontalAlignment: Text.AlignLeft
            // property*: /sim/multiplay/chat-menu/entry[5]
            // live*: true
            color: "#E63333FF"
        }
        ...
        Label {
            text: qsTr("entry-6")
            horizontalAlignment: Text.AlignLeft
            // property*: /sim/multiplay/chat-menu/entry[6]
            // live*: true
            color: "#E63333FF"
        }
        ...
        Label {
            text: qsTr("entry-7")
            horizontalAlignment: Text.AlignLeft
            // property*: /sim/multiplay/chat-menu/entry[7]
            // live*: true
            color: "#E63333FF"
        }
    } // ColumnLayout

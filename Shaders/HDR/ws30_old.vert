...
void main()
{
    ...
    vec4 vertexZUp = fg_zUpTransform * pos;
    ...
    mat4 viewSpaceToZUpSpace = fg_zUpTransform * inverse(osg_ModelViewMatrix);
    ...
    vs_out.steepness = abs(dot(normalize(vec3(fg_zUpTransform * vec4(normal,1.0))), vec3(0.0, 0.0, 1.0)));

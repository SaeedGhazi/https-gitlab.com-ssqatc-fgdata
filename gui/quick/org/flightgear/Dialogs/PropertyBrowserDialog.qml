...
DialogBase {
    id: propertyBrowserDialog

    width: 640
    height: 660
    position: Qt.point(80, 80)

    windowId: propertyBrowserDialog.id
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Label {
                text: qsTr("/")
                // property*: /sim/gui/dialogs/property-browser/title
                // live*: true
            }
            ...
            Button {
                ...
                // border*: 2
				onClicked: {
					propertyBrowserDialog.closed(propertyBrowserDialog.id);
				}
            }
        } // RowLayout
        ...
        RowLayout {
            ...
            Label {
                ...
                Layout.fillWidth: true
                // property*: /sim/gui/dialogs/property-browser/label
                width: 170
            }
            ...
            TextInput {
                ...
                Layout.fillWidth: true
                width: 170
                // property*: /sim/gui/dialogs/property-browser/input
            }

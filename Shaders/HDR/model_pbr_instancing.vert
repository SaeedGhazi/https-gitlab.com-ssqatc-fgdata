...
void main()
{
    ...
    vec3 new_pos = pos.xyz;
    apply_instance_transforms(new_pos, new_normal, instance_position, instance_rotation_and_scale);

    gl_Position = osg_ModelViewProjectionMatrix * vec4(new_pos, 1.0);
    ...
    vs_out.view_vector = (osg_ModelViewMatrix * vec4(new_pos, 1.0)).xyz;
}

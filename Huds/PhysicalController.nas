...
# HUD controller drive by physical properties rather
...
var PhysicalController =
{
  ...
  getAltitudeAGLFt : func
  {
    return getprop("/position/altitude-agl-ft");
  },
  ...
  getElevatorPos : func
  {
    return getprop("/controls/flight/elevator");
  },

  getElevatorTrimPos : func
  {
    return getprop("/controls/flight/elevator-trim");
  },

  getAileronPos : func
  {
    return getprop("/controls/flight/aileron");
  },

  getAileronTrimPos : func
  {
    return getprop("/controls/flight/aileron-trim");
  },

  getRudderPos : func
  {
    return getprop("/controls/flight/rudder");
  },

  getRudderTrimPos : func
  {
    return getprop("/controls/flight/rudder-trim");
  },
